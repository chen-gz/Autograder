/*
 * ece0301_fall2019_inclass04_step07.cpp
 */
...
int main()
{
	...
	else if (lineFromFile == "Wheatstone")
	{
		...
		// will fail with divide-by-zero, or possibly unstable
		// division by a very small denominator
		if ( ( R2 == 0 ) || ( R3 == 0 ) || ( abs(Vs - Is*R4) < 1e-13 ) || ( abs(Vs + Is*R5) < 1e-13 ) )
		{
