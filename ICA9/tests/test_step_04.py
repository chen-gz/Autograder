...
compile_command_student = f"g++ ./submissions/ece0301_ICA09_step04.cpp -o {test_working_dir}/submission"
compile_command_solution = f"g++ ./reference/ece0301_ICA09_step04.cpp -o {test_working_dir}/submission"
