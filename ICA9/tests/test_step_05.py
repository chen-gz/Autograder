...
test_cases_path = "test_cases/step05"
...
compile_command_student = f"g++ ./submissions/ece0301_ICA09_step05.cpp -o {test_working_dir}/submission"
compile_command_solution = f"g++ ./reference/ece0301_ICA09_step05.cpp -o {test_working_dir}/submission"
